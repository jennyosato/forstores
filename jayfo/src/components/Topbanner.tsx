...
const Topbanner = () => {
  return (
    ...
    <div className='w-full h-96 bg-white/70 shadow-sm flex items-center'>
        ...
        <h1 className='text-5xl font-bold '>One stop shop to transform your home</h1>
        <button className='shadow-lg px-4 py-2 bg-gray-400 hover:bg-white hover:text-gray-500 rounded-lg font-bold text-white'>Shop Now</button>
        </div>
